...
DEBUG = False
DEFINES = ['HAVE_LV2=1', 'HAVE_LILV=1', 'HAVE_SERD=1', 'HAVE_SORD=1', 'HAVE_SUIL=1', 'HAVE_SRATOM=1', 'JALV_VERSION="1.4.6"']
DEFINES_ST = '-D%s'
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
INCLUDES_LILV = ['/usr/include/sratom-0', '/usr/include/sord-0', '/usr/include/serd-0', '/usr/include/lilv-0']
...
define_key = ['HAVE_LV2', 'HAVE_LILV', 'HAVE_SERD', 'HAVE_SORD', 'HAVE_SUIL', 'HAVE_SRATOM', 'JALV_VERSION']
